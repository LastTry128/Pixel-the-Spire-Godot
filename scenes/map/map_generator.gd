...
const SHOP_ROOM_WEIGHT := 2
const CAMFIRE_ROOM_WEIGHT := 3
...
func _setup_random_room_weights() -> void:
	random_room_type_total_weight = MONSTER_ROOM_WEIGHT + CAMFIRE_ROOM_WEIGHT + SHOP_ROOM_WEIGHT
	...
	random_room_type_weights[Room.Type.Campfire] = MONSTER_ROOM_WEIGHT + CAMFIRE_ROOM_WEIGHT + SHOP_ROOM_WEIGHT
